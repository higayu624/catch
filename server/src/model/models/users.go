...
var UserTableColumns = struct {
	...
	Gender:            "users.gender",
	Age:               "users.age",
	GoogleAccessToken: "users.google_access_token",
}
...
var UserWhere = struct {
	...
	Age:               whereHelpernull_Int64{field: "\"users\".\"age\""},
	GoogleAccessToken: whereHelpernull_String{field: "\"users\".\"google_access_token\""},
}
...
var (
	userAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "name", "email", "gender", "age", "google_access_token"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at", "name", "email", "gender", "age", "google_access_token"}
