...
var VisitTableColumns = struct {
	...
	DeletedAt: "visits.deleted_at",
	UserID:    "visits.user_id",
	StoreID:   "visits.store_id",
}
...
var VisitWhere = struct {
	...
	CreatedAt: whereHelpernull_Time{field: "\"visits\".\"created_at\""},
	UpdatedAt: whereHelpernull_Time{field: "\"visits\".\"updated_at\""},
	DeletedAt: whereHelpernull_Time{field: "\"visits\".\"deleted_at\""},
	UserID:    whereHelpernull_Int64{field: "\"visits\".\"user_id\""},
	StoreID:   whereHelpernull_Int64{field: "\"visits\".\"store_id\""},
}
...
var (
	visitAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "user_id", "store_id"}
	visitColumnsWithoutDefault = []string{}
	visitColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at", "user_id", "store_id"}
	visitPrimaryKeyColumns     = []string{"id"}
	visitGeneratedColumns      = []string{}
)
...
var visitAfterSelectMu sync.Mutex
var visitAfterSelectHooks []VisitHook

var visitBeforeInsertMu sync.Mutex
var visitBeforeInsertHooks []VisitHook
var visitAfterInsertMu sync.Mutex
var visitAfterInsertHooks []VisitHook

var visitBeforeUpdateMu sync.Mutex
var visitBeforeUpdateHooks []VisitHook
var visitAfterUpdateMu sync.Mutex
var visitAfterUpdateHooks []VisitHook

var visitBeforeDeleteMu sync.Mutex
var visitBeforeDeleteHooks []VisitHook
var visitAfterDeleteMu sync.Mutex
var visitAfterDeleteHooks []VisitHook

var visitBeforeUpsertMu sync.Mutex
var visitBeforeUpsertHooks []VisitHook
var visitAfterUpsertMu sync.Mutex
...
func FindVisit(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Visit, error) {
	visitObj := &Visit{}
...
func VisitExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
...
func (o *Visit) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return VisitExists(ctx, exec, o.ID)
}
