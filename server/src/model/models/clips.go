...
type Clip struct {
	...
	S3Token     null.String `boil:"s3_token" json:"s3_token,omitempty" toml:"s3_token" yaml:"s3_token,omitempty"`
...
var ClipTableColumns = struct {
	...
	UpdatedAt:   "clips.updated_at",
	DeletedAt:   "clips.deleted_at",
	StoreID:     "clips.store_id",
	Name:        "clips.name",
	S3Token:     "clips.s3_token",
...
var ClipWhere = struct {
	...
	S3Token     whereHelpernull_String
	Description whereHelpernull_String
}{
	ID:          whereHelperint64{field: "\"clips\".\"id\""},
	CreatedAt:   whereHelpernull_Time{field: "\"clips\".\"created_at\""},
	UpdatedAt:   whereHelpernull_Time{field: "\"clips\".\"updated_at\""},
	DeletedAt:   whereHelpernull_Time{field: "\"clips\".\"deleted_at\""},
	StoreID:     whereHelpernull_Int64{field: "\"clips\".\"store_id\""},
	Name:        whereHelpernull_String{field: "\"clips\".\"name\""},
	S3Token:     whereHelpernull_String{field: "\"clips\".\"s3_token\""},
...
var (
	clipAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "store_id", "name", "s3_token", "description"}
	clipColumnsWithoutDefault = []string{}
	clipColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at", "store_id", "name", "s3_token", "description"}
...
var clipAfterSelectMu sync.Mutex
var clipAfterSelectHooks []ClipHook

var clipBeforeInsertMu sync.Mutex
var clipBeforeInsertHooks []ClipHook
var clipAfterInsertMu sync.Mutex
var clipAfterInsertHooks []ClipHook

var clipBeforeUpdateMu sync.Mutex
var clipBeforeUpdateHooks []ClipHook
var clipAfterUpdateMu sync.Mutex
var clipAfterUpdateHooks []ClipHook

var clipBeforeDeleteMu sync.Mutex
var clipBeforeDeleteHooks []ClipHook
var clipAfterDeleteMu sync.Mutex
var clipAfterDeleteHooks []ClipHook

var clipBeforeUpsertMu sync.Mutex
var clipBeforeUpsertHooks []ClipHook
var clipAfterUpsertMu sync.Mutex
...
func (o *Clip) Store(mods ...qm.QueryMod) storeQuery {
...
func (clipL) LoadStore(ctx context.Context, e boil.ContextExecutor, singular bool, maybeClip interface{}, mods queries.Applicator) error {
	var slice []*Clip
	var object *Clip
	...
	if singular {
		...
		foreign.R.Clips = append(foreign.R.Clips, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.StoreID, foreign.ID) {
				...
				foreign.R.Clips = append(foreign.R.Clips, local)
				break
			}
		}
	}
...
// SetStore of the clip to the related item.
// Sets o.R.Store to related.
// Adds o to related.R.Clips.
func (o *Clip) SetStore(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Store) error {
	var err error
	if insert {
	...
	if related.R == nil {
		...
		related.R.Clips = append(related.R.Clips, o)
	}
...
func (o *Clip) RemoveStore(ctx context.Context, exec boil.ContextExecutor, related *Store) error {
	var err error
	...
	for i, ri := range related.R.Clips {
		if queries.Equal(o.StoreID, ri.StoreID) {
			continue
		}

		ln := len(related.R.Clips)
		if ln > 1 && i < ln-1 {
			related.R.Clips[i] = related.R.Clips[ln-1]
		}
		related.R.Clips = related.R.Clips[:ln-1]
		break
	}
	return nil
}
...
func (o *Clip) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(clipAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(clipPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert clips, could not build conflict column list")
			}

			conflict = make([]string, len(clipPrimaryKeyColumns))
			copy(conflict, clipPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"clips\"", updateOnConflict, ret, update, conflict, insert, opts...)
