...
var LocationWhere = struct {
	...
	UserID:    whereHelpernull_Int64{field: "\"locations\".\"user_id\""},
	Latitude:  whereHelpertypes_NullDecimal{field: "\"locations\".\"latitude\""},
	Longitude: whereHelpertypes_NullDecimal{field: "\"locations\".\"longitude\""},
}
...
var (
	locationAllColumns            = []string{"id", "created_at", "updated_at", "deleted_at", "user_id", "latitude", "longitude"}
	locationColumnsWithoutDefault = []string{}
	locationColumnsWithDefault    = []string{"id", "created_at", "updated_at", "deleted_at", "user_id", "latitude", "longitude"}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(locationPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert locations, could not build conflict column list")
			}
